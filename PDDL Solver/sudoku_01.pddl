(define
	...
	(:init
		...
		(= (cell_value one one) 6)
		(= (cell_value two one) 5)
		(= (cell_value three one) 9)
		(= (cell_value four one) 2)
		(= (cell_value five one) 7)
		(= (cell_value six one) 1)
		(= (cell_value seven one) 3)
		(= (cell_value eight one) 4)
		(= (cell_value nine one) 0)

		(= (cell_value one two) 4)
		(= (cell_value two two) 3)
		(= (cell_value three two) 8)
		(= (cell_value four two) 9)
		(= (cell_value five two) 5)
		(= (cell_value six two) 6)
		(= (cell_value seven two) 1)
		(= (cell_value eight two) 2)
		(= (cell_value nine two) 7)

		(= (cell_value one three) 1)
		(= (cell_value two three) 2)
		(= (cell_value three three) 7)
		(= (cell_value four three) 3)
		(= (cell_value five three) 8)
		(= (cell_value six three) 4)
		(= (cell_value seven three) 0)
		(= (cell_value eight three) 5)
		(= (cell_value nine three) 6)

		(= (cell_value one four) 8)
		(= (cell_value two four) 4)
		(= (cell_value three four) 2)
		(= (cell_value four four) 0)
		(= (cell_value five four) 3)
		(= (cell_value six four) 7)
		(= (cell_value seven four) 5)
		(= (cell_value eight four) 9)
		(= (cell_value nine four) 1)

		(= (cell_value one five) 3)
		(= (cell_value two five) 9)
		(= (cell_value three five) 5)
		(= (cell_value four five) 1)
		(= (cell_value five five) 2)
		(= (cell_value six five) 8)
		(= (cell_value seven five) 6)
		(= (cell_value eight five) 7)
		(= (cell_value nine five) 4)

		(= (cell_value one six) 7)
		(= (cell_value two six) 0)
		(= (cell_value three six) 1)
		(= (cell_value four six) 0)
		(= (cell_value five six) 0)
		(= (cell_value six six) 5)
		(= (cell_value seven six) 8)
		(= (cell_value eight six) 3)
		(= (cell_value nine six) 2)

		(= (cell_value one seven) 9)
		(= (cell_value two seven) 7)
		(= (cell_value three seven) 4)
		(= (cell_value four seven) 0)
		(= (cell_value five seven) 1)
		(= (cell_value six seven) 0)
		(= (cell_value seven seven) 2)
		(= (cell_value eight seven) 6)
		(= (cell_value nine seven) 5)

		(= (cell_value one eight) 2)
		(= (cell_value two eight) 1)
		(= (cell_value three eight) 6)
		(= (cell_value four eight) 5)
		(= (cell_value five eight) 4)
		(= (cell_value six eight) 9)
		(= (cell_value seven eight) 7)
		(= (cell_value eight eight) 8)
		(= (cell_value nine eight) 3)

		(= (cell_value one nine) 5)
		(= (cell_value two nine) 8)
		(= (cell_value three nine) 3)
		(= (cell_value four nine) 7)
		(= (cell_value five nine) 0)
		(= (cell_value six nine) 2)
		(= (cell_value seven nine) 4)
		(= (cell_value eight nine) 1)
		(= (cell_value nine nine) 9)
